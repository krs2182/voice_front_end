...
apigClientFactory.newClient = function (config) {
    ...
    var invokeUrl = 'https://8hddakqo75.execute-api.us-east-1.amazonaws.com/final';
    ...
    apigClient.searchPhotosOptions = function (params, body, additionalParams) {
        if(additionalParams === undefined) { additionalParams = {}; }
        
        apiGateway.core.utils.assertParametersDefined(params, [], ['body']);
        
        var searchPhotosOptionsRequest = {
            verb: 'options'.toUpperCase(),
        ...
        return apiGatewayClient.makeRequest(searchPhotosOptionsRequest, authType, additionalParams, config.apiKey);
    };
